package com.example.demo.exception.exceptioncontact;
...
@ControllerAdvice
public class ExceptionControllerContact {
    private final ExceptionErrors exceptionErrors = new ExceptionErrors();

    @ExceptionHandler(ExceptionNotFoundContact.class)
    @ResponseBody
    public ResponseEntity handlerExceptionNotFoundContact(ExceptionNotFoundContact ex){
