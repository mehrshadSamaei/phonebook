...
public class PhoneBookServiceImpl extends
        BaseServiceImpl<PhoneBook , PhoneBookResponseDTO ,
                PhoneBookRequestDTO , Long , PhoneBookResponseMapper , PhoneBookRepository>
        implements PhoneBookService {


    public PhoneBookServiceImpl(PhoneBookRepository repository, PhoneBookResponseMapper phoneBookResponseMapper) {
        super(repository, phoneBookResponseMapper);
    }

    @Override
    public List<PhoneBookResponseDTO> findAllByAdvanceSearch(PhoneBookSearch phoneBookSearch) {
        repository.findAll(
